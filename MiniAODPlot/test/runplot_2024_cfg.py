...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    '/store/user/wuzh/Muon/Run2022C_mini_v2/251118_145228/0000/MiniAOD_3-16.root'
  )
)
...
process.noise_filter = hlt.hltHighLevel.clone(
    ...
    HLTPaths = ['Flag_goodVertices','Flag_globalSuperTightHalo2016Filter','Flag_EcalDeadCellTriggerPrimitiveFilter','Flag_BadPFMuonFilter','Flag_BadPFMuonDzFilter','Flag_hfNoisyHitsFilter','Flag_eeBadScFilter','Flag_ecalBadCalibFilter'],
    andOr = False,
    throw = True
    )
