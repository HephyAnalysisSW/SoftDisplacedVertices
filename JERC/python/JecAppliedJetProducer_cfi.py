...
jecAppliedJetProducer = cms.EDProducer(
    ...
    Jets = cms.PSet(
        ...
        JecConfig = cms.FileInPath("SoftDisplacedVertices/JERC/data/JecConfigAK4.json"),
        JerToolConfig = cms.FileInPath("SoftDisplacedVertices/JERC/data/jer_smear.json.gz"),
    ),
)
