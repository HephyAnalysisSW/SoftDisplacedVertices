...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/users/alikaan.gueven/AOD_to_nanoAOD/Run3_submissions/CMSSW_15_0_2/src/SoftDisplacedVertices/CustomMiniAOD/testK/MiniAODSIM.root'),
