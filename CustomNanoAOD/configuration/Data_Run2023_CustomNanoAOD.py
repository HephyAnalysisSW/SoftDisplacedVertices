...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:$CMSSW_BASE/src/SoftDisplacedVertices/CustomMiniAOD/configuration/run2023_example_pv.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('run2023_example_nano_pv.root'),
