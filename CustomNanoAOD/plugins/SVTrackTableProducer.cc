...
void SVTrackTableProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  svsTable->addColumn<float>("tk_dist2d_min", tk_dist2d_min, "Min track dxy wrt the vertex", 10);
  svsTable->addColumn<float>("tk_dist2d_max", tk_dist2d_max, "Max track dxy wrt the vertex", 10);
  svsTable->addColumn<float>("tk_dist2d_min_sig", tk_dist2d_min_sig, "Min track dxy significance wrt the vertex", 10);
  svsTable->addColumn<float>("tk_dist2d_max_sig", tk_dist2d_max_sig, "Max track dxy significance wrt the vertex", 10);
  svsTable->addColumn<float>("tk_dist3d_min", tk_dist3d_min, "Min track d3d wrt the vertex", 10);
