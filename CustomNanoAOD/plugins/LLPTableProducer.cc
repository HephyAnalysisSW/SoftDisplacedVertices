...
void LLPTableProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  genPartTable->addColumn<int>("pdgId",genpart_pdgId, "pdgId", nanoaod::FlatTable::IntColumn);
  ...
  genSecVtxTable->addColumn<int>("LLPIdx",gensecvtx_llpidx, "LLP index", nanoaod::FlatTable::IntColumn);
  genSecVtxTable->addColumn<float>("vertex_x",gensecvtx_x, "x position of gen secondary vertex", nanoaod::FlatTable::FloatColumn, 10);
  genSecVtxTable->addColumn<float>("vertex_y",gensecvtx_y, "y position of gen secondary vertex", nanoaod::FlatTable::FloatColumn, 10);
  genSecVtxTable->addColumn<float>("vertex_z",gensecvtx_z, "z position of gen secondary vertex", nanoaod::FlatTable::FloatColumn, 10);
  ...
  tkTable->addColumn<int>("GenSecVtxIdx", tk_gensecvtxidx, "GenSecVtx index", nanoaod::FlatTable::IntColumn);
