...
def draw_2dlimit():
  ...
  canv.GetListOfPrimitives()[1].SetTitleSize(0.045, "XYZ")
  canv.GetListOfPrimitives()[1].SetTitleOffset(1.4, "XYZ")
  limit['observed'].GetZaxis().SetTitle("95% CL upper limit on #sigma#bf{#it{#Beta}}^{2} (fb)")
...
path = '/users/ang.li/public/SoftDV/Combine/CMSSW_14_1_0_pre4/src/HiggsAnalysis/CombinedLimit/datacards/limit_STOP_Run2_20250307/'
...
output = '/groups/hephy/cms/ang.li/SDV/{}limit_run2_20250307/'.format(model)
make_1dplot()
draw_2dlimit()
