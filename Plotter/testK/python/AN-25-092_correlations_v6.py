...
os.environ.setdefault("MPLCONFIGDIR", "/tmp/matplotlib-AN-25-092-correlations-v6")
for thread_var in (
    "OMP_NUM_THREADS",
...
def save_outputs(level, corr):
    out_csv = OUT_DIR / f"AN-25-092_correlations_v6_{level}.csv"
    out_png = OUT_DIR / f"AN-25-092_correlations_v6_{level}.png"
    out_pdf = OUT_DIR / f"AN-25-092_correlations_v6_{level}.pdf"
    corr.to_csv(out_csv)
