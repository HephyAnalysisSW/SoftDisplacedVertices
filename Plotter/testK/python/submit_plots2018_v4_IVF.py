...
json_db = {
    'sig'  : 'clip_IVF_testK.json',
    'bkg'  : 'clip_IVF_testK.json',
...
config =           "$CMSSW_BASE/src/SoftDisplacedVertices/Plotter/configs/2018/vtx_PART_1111best_valloss_epoch_test_deltaphi.yaml"
