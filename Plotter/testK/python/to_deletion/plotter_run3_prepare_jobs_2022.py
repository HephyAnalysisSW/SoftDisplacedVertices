...
samples_to_plot = {
    ...
    'bkg_pre':   [sample.name for sample in ss.bkg_2022Pre],
    'bkg_post':  [sample.name for sample in ss.bkg_2022Post],
    'data_pre':  [sample.name for sample in ss.met_2022Pre],
    'data_post': [sample.name for sample in ss.met_2022Post]
}

json_db = {
    'sig_18':    'scratch_sig18.json',
    'bkg_pre':   'scratch_MC22.json',
    'bkg_post':  'scratch_MC22.json',
    'data_pre':  'scratch_data22.json' ,
    'data_post': 'scratch_data22.json'
}
