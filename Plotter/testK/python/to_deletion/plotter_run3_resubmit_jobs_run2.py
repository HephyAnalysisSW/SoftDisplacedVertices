...
if __name__=="__main__":
    ...
    file_paths = {
        'sig17':  os.path.join(outBaseDir,   'sig17/job_ids.json'),
        'bkg17':  os.path.join(outBaseDir,   'bkg17/job_ids.json'),
        'data17': os.path.join(outBaseDir,  'data17/job_ids.json'),
        
        'sig18':  os.path.join(outBaseDir,   'sig18/job_ids.json'),
        'bkg18':  os.path.join(outBaseDir,   'bkg18/job_ids.json'),
        'data18': os.path.join(outBaseDir,  'data18/job_ids.json'),
                }
