...
if __name__=="__main__":
    ...
    file_paths = {
        # "sig_18": os.path.join(outBaseDir, "sig_18",    "job_ids.json"),
        "bkg_pre": os.path.join(outBaseDir, "bkg_pre",   "job_ids.json"),
        "bkg_post": os.path.join(outBaseDir, "bkg_post",  "job_ids.json"),
        "data_post": os.path.join(outBaseDir, "data_post", "job_ids.json"),
        "data_post": os.path.join(outBaseDir, "data_post", "job_ids.json")
    }
