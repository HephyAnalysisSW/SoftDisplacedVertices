...
json_db = {
    'sig24':  'scratch_sig18.json',
    'bkg24':  'scratch_MC24.json',
    'data24': 'scratch_data24.json'
}
...
config =           "$CMSSW_BASE/src/SoftDisplacedVertices/Plotter/configs/plotconfig_Run3_check_inclusive.yaml"
outDir_base = "/scratch-cbe/users/alikaan.gueven/AN_plots/"
work_subdir = "ParT_hists"
unique_dir  = "plotconfig_Run3_check_inclusive"
files_per_job = 2
