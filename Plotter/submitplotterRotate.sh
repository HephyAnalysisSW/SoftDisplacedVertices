...
### DATA
python3 autoplotter.py --sample met_2018 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi -1 --json RotateR.json --datalabel CustomNanoAOD --data --year 2018 --nfiles 2 --submit
...
### BKG MC
python3 autoplotter.py --sample znunu_2018 wlnu_2018 qcd_2018 top_2018 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi 59683. --json RotateR.json --datalabel CustomNanoAOD --year 2018 --nfiles 5 --submit
