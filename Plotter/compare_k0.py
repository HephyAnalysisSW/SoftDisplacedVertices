...
parser.add_argument('--bkg_scale', type=float, default=1,
...
def comparehists_cms(name,hs,colors,legends,sig_scale=[], scale_to_data=False, ratio=True, norm=False):
  ...
  if ratio:
    # Create canvas
    canv = CMS.cmsDiCanvas(name, x_min, x_max, y_min, (y_max-y_min)/0.65+y_min, 0.5, 1.5, x_label, y_label, "Data/MC", square=square, extraSpace=0.1, iPos=iPos,)
  else:
