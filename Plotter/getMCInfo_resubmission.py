...
if __name__=="__main__":
    outDir_base = "/users/alikaan.gueven/AOD_to_nanoAOD/Plotter_run3/CMSSW_15_0_5/src/SoftDisplacedVertices/Plotter/testK"
    work_subdir = "sumWeights"
    ...
    file_path = os.path.join(outBaseDir, 'job_ids.json')
