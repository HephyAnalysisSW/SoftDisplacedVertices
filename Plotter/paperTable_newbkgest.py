...
if __name__=="__main__":
  ...
  for i in range(len(sig_fns)):
    devts17 = getEvts("met2017_hist.root",args.SR)
    devts18 = getEvts("met2018_hist.root",args.SR)
    devts_pred17 = predict_full(devts17, '2017')
    devts_pred18 = predict_full(devts18, '2018')
    devts = addEvts([devts17,devts18])
    devts_pred = addEvts([devts_pred17,devts_pred18])
