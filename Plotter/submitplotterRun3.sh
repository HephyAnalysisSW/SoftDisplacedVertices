...
### DATA
python3 autoplotter.py --sample met_2018 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi -1 --json scratch_data18.json --datalabel CustomNanoAOD --data --year 2018 --nfiles 2 --submit
...
### BKG MC
python3 autoplotter.py --sample znunu_2018 wlnu_2018 qcd_2018 top_2018 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi 59683. --json scratch_sig18.json --datalabel CustomNanoAOD --year 2018 --nfiles 5 --submit
...
#submit jobs.sh 
python3 autoplotter.py --sample C1N2ML_M200_195_ct20_2018 C1N2ML_M200_185_ct20_2018 stopML_M1000_988_ct200_2018 stopML_M1000_980_ct2_2018 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi 59683. --json scratch_sig18.json --datalabel CustomNanoAOD --year 2018 --submit
cp jobs.sh jobs_sig18.sh

### DATA
python3 autoplotter.py --sample met_2017 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi -1 --json scratch_data18.json --datalabel CustomNanoAOD --data --year 2017 --nfiles 2 --submit
...
### MC
python3 autoplotter.py --sample znunu_2017 wlnu_2017 qcd_2017 top_2017 --output /scratch-cbe/users/ang.li/SoftDV/Histos/Histos_${1} --config configs/plotconfig_Run2_${2}.yaml --lumi 40610. --json scratch_MC18.json --datalabel CustomNanoAOD --year 2017 --nfiles 5 --submit
