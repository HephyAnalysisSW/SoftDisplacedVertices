...
STORE="/scratch/ang.li/GenOutput_C1N2qCut30"
...
directories=("PROCESS_LLPMASS_LSPMASS_CTAUVALUE" "PROCESS_LLPMASS_LSPMASS_CTAUVALUE/GEN")
...
cp $HOME/CMSSW_10_6_30/src/LHEGEN.root PROCESS_LLPMASS_LSPMASS_CTAUVALUE/GEN/$RUN_NUMBER-testIVF1_GENSIM_PROCESS_LLPMASS_LSPMASS_CTAUVALUE_Standard_EVENTCOUNT.root
#cp $HOME/CMSSW_10_6_30/src/AODSIM.root PROCESS_LLPMASS_LSPMASS_CTAUVALUE/AODSIM/$RUN_NUMBER-testIVF1_AODSIM_PROCESS_LLPMASS_LSPMASS_CTAUVALUE_Standard_EVENTCOUNT.root
#cp $HOME/CMSSW_10_6_30/src/MINIAODSIM.root PROCESS_LLPMASS_LSPMASS_CTAUVALUE/MINIAODSIM/$RUN_NUMBER-testIVF1_MINIAODSIM_PROCESS_LLPMASS_LSPMASS_CTAUVALUE_Standard_EVENTCOUNT.root
#cp $HOME/CMSSW_10_6_30/src/NANOAODSIM.root PROCESS_LLPMASS_LSPMASS_CTAUVALUE/NANOAODSIM/$RUN_NUMBER-testIVF1_NANOAODSIM_PROCESS_LLPMASS_LSPMASS_CTAUVALUE_Standard_EVENTCOUNT.root
